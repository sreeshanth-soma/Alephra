...
export const ContainerScroll = ({
  ...
  // Smooth the raw scroll progress to reduce jitter
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className=" h-full w-full  overflow-hidden rounded-2xl bg-gray-100 dark:bg-zinc-900 md:rounded-2xl md:p-4 will-change-transform ">
        {children}
      </div>
    </motion.div>
  );
