...
export async function POST(req: Request, res: Response) {
    try {
        ...
        const finalPrompt = `Here is a summary of a patient's clinical report (if provided), and a user query. Some generic clinical findings are also provided that may or may not be relevant for the report.
